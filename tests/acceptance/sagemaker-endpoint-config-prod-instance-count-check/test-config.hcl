...
case "Sagemaker Endpoint Config Prod with Initial Instance Count Attribute" {
    path = "./cases/sagemaker-endpoint-config-prod-with-initial-instance-count-attribute"
    expectation {
        result = true
    }
}
